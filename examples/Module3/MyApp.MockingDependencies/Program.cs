...
using MyApp.MockingDependencies.Options;
...
builder.Services.AddScoped<IApiServiceWithClientFactory, ApiServiceWithClientFactory>();
...
builder.Services.AddHttpClient("ApiServiceHttpClientName", (serviceProvider, client) =>
{
